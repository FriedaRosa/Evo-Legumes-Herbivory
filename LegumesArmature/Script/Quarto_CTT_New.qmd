...
#2. Cummulative Transition rates 
...
```{r}
#| label: Plot 1: Mean transition times Histogram 
#| warning: FALSE
...
```{r}
rm(list=ls())
#| label: Mammals Modified Fig4 Pollination Study 
...
# add data-points with noise in the X-axis
rug(jitter(other_to_mega$other_to_mega), col = my_cols[1])
rug(jitter(mega_to_other$mega_to_other), col = my_cols[2])
