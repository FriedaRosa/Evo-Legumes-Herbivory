...
tree_legumes <- readRDS("../../input/Legumes/Processed/Legumes_MCC_drop.rds")
...
Mass <- numeric(length = nrow(trait))

# Create the 'Mass' factor based on the 'Condition_Met' column
Mass <- ifelse(trait$Condition_Met == 0, "other", "megaherbivore")
...
names(Mass) <- rownames(trait)
Mass <- evobiR::ReorderData(tree, Mass, taxa.names="names")
...
trait <- readRDS("../../input/Legumes/Processed/Legumes_traits_drop.rds")
tree <- readRDS("../../input/Legumes/Processed/Legumes_MCC_drop.rds")
