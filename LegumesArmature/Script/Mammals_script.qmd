...
o2m <- hist(other2mega$other2mega, breaks = ax, plot = FALSE)
m2o <- hist(mega2other$mega2other, breaks = ax, plot = FALSE)

plot (o2m, col = myColours[1], xlab = "Time of transitions (mya)",  
      main = "", ylab = "number of transitions", 
      ylim = c(0, 40), xlim = c(220,0)) # alter if x values change!
plot (m2o, col = my_cols[2], add = TRUE)
...
# calculate density curve
density_m2o <- density(mega2other$mega2other)
density_o2m <- density(other2mega$other2mega)
...
for(n in 1:100){
  ...
  points(mega2other$trans_no ~ mega2other$time, 
         col = my_cols[1], pch = 15, xlim = c(220,0), ylim = c(0,40))
  lines(mega2other$trans_no ~ mega2other$time, 
        col = my_cols[1],xlim = c(220,0), ylim = c(0,40))
  points(other2mega$trans_no ~ other2mega$time, 
         col = my_cols[2], pch = 17,xlim = c(220,0), ylim = c(0,40))
  lines(other2mega$trans_no ~ other2mega$time, 
        col =my_cols[2],xlim = c(220,0), ylim = c(0,40))
}
...
points(mega2other$trans_no ~ mega2other$avg_time,
       col = "darkgrey", pch = 15, xlim = c(220,0), ylim = c(0,40))
lines(mega2other$trans_no ~ mega2other$avg_time, 
      col = "darkgrey", lwd = 3,xlim = c(220,0), ylim = c(0,40))
points(other2mega$trans_no ~ other2mega$avg_time,
       col = "#FFBB00", pch = 17,xlim = c(220,0), ylim = c(0,40))
lines(other2mega$trans_no ~ other2mega$avg_time, 
      col = "#FFBB00", lwd = 3,xlim = c(220,0), ylim = c(0,40))
...
# first set up basic plot parameters
plot(mega2other$trans_no ~ mega2other$time,
     type = "p", bty = "l", xlim = c(100,0), ylim = c(0,40),
     col = my_cols[2], pch = 15,
     xlab = "Time of transitions (mya)", 
     ylab = "number of transitions",
     cex.lab = 1.8, cex.axis = 1.8)
